...
const UserTypeForm = () => {
  ...
  const { name, email, password } = params as { name: string; email: string; password: string };
  ...
  const handleContinue = async () => {
    if (selectedType && name && email && password) {
      try {
        // Call signup - the userType will be sent in the name field or stored separately
        // Option 1: Include userType in the signup call if you modify AuthContext
        await signup(email, password, `${name}|${selectedType}`);
        
        // Option 2: Or call signup normally and then update user profile with userType
    ...
    <Background>
      <View style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          ...
          {/* Continue Button */}
          <TouchableOpacity 
            style={[styles.continueButton, (!selectedType || isLoading) && styles.continueButtonDisabled]}
